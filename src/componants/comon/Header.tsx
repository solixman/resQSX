   ...
   return (
    <header className='flex border-b border-gray-300 py-3 px-4 sm:px-10 bg-white min-h-[65px] tracking-wide relative z-50'>
      <div className='flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full'>
        <a href="javascript:void(0)" id="logo" className="max-sm:hidden"><img src="/src/assets/QSXLogo.png" alt="logo" className='w-[134px]' />
        </a>
        ...
        <div id="collapseMenu"
          ...
          <button id="toggleClose" className='lg:hidden fixed top-2 right-4 z-[100] rounded-full bg-white w-9 h-9 flex items-center justify-center border border-gray-200 cursor-pointer'>
            <svg xmlns="/src/assets/QSXLogo.png" className="w-3.5 h-3.5 fill-slate-900" viewBox="0 0 320.591 320.591">
              <path
